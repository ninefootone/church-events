...
function ce_register_meta() {
	...
	$fields = array(
		...
		'event_start_time'  => array( 'description' => 'Start time (HH:MM:SS)' ),
		'event_end_date'    => array( 'description' => 'End date (YYYYMMDD)' ),
		'event_end_time'    => array( 'description' => 'End time (HH:MM:SS)' ),
		'event_all_day'     => array(
...
function ce_render_meta_box( $post ) {
	...
	$fields = array(
		...
		'event_start_time'   => __( 'Start Time (HH:MM:SS)', 'church-events' ),
		'event_end_date'     => __( 'End Date (YYYYMMDD)', 'church-events' ),
		'event_end_time'     => __( 'End Time (HH:MM:SS)', 'church-events' ),
